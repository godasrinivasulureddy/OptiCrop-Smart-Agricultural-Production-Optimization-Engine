...
import { Sprout, Mail, Lock, User, ArrowRight, AlertCircle, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-[fade-in_0.5s_ease-out]">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Join OptiCrop to optimize your yield</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-3 px-4 py-3 bg-black/20 border border-white/10 rounded-lg transition-all duration-200 focus-within:border-emerald-500 focus-within:ring-1 focus-within:ring-emerald-500">
                <User className="text-slate-500 shrink-0" size={18} />
                <input 
                  type="text" 
            ...
            <button 
              type="submit" 
              disabled={isLoading}
              className="btn-primary w-full flex items-center justify-center gap-2 py-2.5 mt-4 disabled:opacity-50 disabled:cursor-not-allowed"
            >
